...
>(({ className, ...props }, ref) => (
  <div className="srs-table-wrap w-full">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-3 text-left align-middle text-xs font-semibold text-primary sm:h-11 sm:px-4 sm:text-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-3 align-middle text-xs sm:p-4 sm:text-sm", className)}
    {...props}
  />
));
